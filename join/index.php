...
{
    $form['name'] = filter_input(INPUT_POST , 'name' , FILTER_UNSAFE_RAW);
    if ($form['name'] === '') {
        $error['name'] = 'blank';
    }
    $form['email'] = filter_input(INPUT_POST, 'email' , FILTER_UNSAFE_RAW);
    if ($form['email'] === '') {
        $error['email'] = 'blank';
    }else{
        $db = dbconnect();
    ...
    $form['password']=filter_input(INPUT_POST , 'password' , FILTER_UNSAFE_RAW);
    if ($form['password'] === '') {
